...
Algoritmos: Linear e Polinomial Regression (Lasso, Ridge, Elastic Net e Ransac), Decision Tree Regressor e Random Forest Regressor
Métricas de avaliação: R2, MSE, RMSE, MAE e MAPE
...
Python 3.11.14 e Scikit-learn

# Desenvolvimento

## Estratégia da solução

Para o objetivo de ensaiar os algoritmos de Machine Learning, eu irei escrever os códigos utilizando a linguagem Python, para treinar cada um dos algoritmos e vou variar seus principais parâmetros de ajuste de overfitting e observar a métrica final.
